...
try {
    ...
    $statsStmt = $conn->query("
        SELECT
            ...
            COALESCE(SUM(status = 'Active'), 0) AS active_teachers,
            COALESCE(SUM(status = 'Inactive'), 0) AS inactive_teachers
        FROM teachers
    ");
...
function teacher_index_e(mixed $value): string
{
...
function teacher_index_date(?string $value): string
{
    if (!$value) {
        return '—';
    }
...
function teacher_index_datetime(?string $value): string
{
    if (!$value) {
        return 'Never';
    }
...
<style>
    ...
    .teacher-stat {
        ...
        box-shadow: 0 15px 40px rgba(51,51,51,.07);
...
<div class="dashboard-wrapper">
    ...
    <div class="main-content">
        ...
        <main class="dashboard-content teacher-management-page">
            ...
            <section class="teacher-heading">
                ...
                <div>
                    ...
                    <p>
                        Manage teacher accounts, profiles and account status.
                    </p>
            ...
            <section class="teacher-stats">
                ...
                <article class="teacher-stat">
                    ...
                    <div>
                        <small>Inactive Teachers</small>
                        <strong>
                            <?= (int)$stats['inactive_teachers'] ?>
                        </strong>
                    </div>
            ...
            <section class="teacher-list-card">

                <header class="teacher-list-header">
                    ...
                    >
                        ...
                        <div class="input-group teacher-search">

                            <input
                                type="search"
                                name="search"
                                class="form-control"
                                value="<?= teacher_index_e($search) ?>"
                            ...
                            <tr>
                                ...
                                <td data-label="Actions">
                                    ...
                                    <div class="teacher-actions">
                                        ...
                                        <a
                                            href="toggle-status.php?id=<?= (int)$teacher['id'] ?>"
                                            class="teacher-action toggle"
                                            title="<?= $teacher['status'] === 'Active'
                                                ? 'Deactivate teacher'
                                                : 'Activate teacher' ?>"
                                        >
                                            <i class="fa-solid <?= $teacher['status'] === 'Active'
                                                ? 'fa-toggle-on'
                                                : 'fa-toggle-off' ?>"></i>
                                        </a>
