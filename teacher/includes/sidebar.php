...
<link
    rel="stylesheet"
    href="assets/css/premium-teacher.css"
>

<link
    rel="stylesheet"
    href="../../assets/css/accessibility.css"
>

<link
    rel="stylesheet"
    href="assets/css/sidebar-scroll.css"
>

<script
    defer
    src="assets/js/teacher-panel.js"
></script>
...
>
    ...
    <nav>
        ...
        <a
            class="
                <?= $teacher_page === 'import_questions.php'
                    ? 'active'
                    : '' ?>
            "
        ...
        <a
            class="
                <?= $teacher_page === 'change_password.php'
                    ? 'active'
                    : '' ?>
            "
